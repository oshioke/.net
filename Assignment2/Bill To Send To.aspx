        ...
        <table  class="style1">
            <tr>
                ...
                <td class="style33">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorBname" 
                    ControlToValidate="txtFirstName" runat="server" ErrorMessage="First Name is required" EnableClientScript="False">*</asp:RequiredFieldValidator>
                </td>
                <td class="style31">
...
************************************************************************************************************************-->
    ...
    <asp:Button ID="btnSubmit" runat="server" Text="Submit" 
        onclick="btnSubmit_Click" PostBackUrl="confirmation.aspx" />
    </form>
</body>
</html>
